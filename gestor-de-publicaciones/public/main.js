...
publicaciones.forEach((pub) => repositorio.agregar(pub));
...
function agregarTarjeta(publicacion) {
  if (publicacion.id === undefined) {
    publicacion.id = repositorio.publicaciones.indexOf(publicacion);
  }
...
function renderizarPublicaciones() {
  ...
  repositorio.publicaciones.forEach((pub) => agregarTarjeta(pub));
}
